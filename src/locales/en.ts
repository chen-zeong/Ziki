...
JPG, PNG, BMP, TIFF, WEBP, SVG etc.`,
  ...
  videoSettings: {
    ...
    random30s: 'Rand 30s',
    random1min: 'Rand 1 min',
    random5min: 'Rand 5 min',
    ...
    qualitySame: 'same quality',
    qualityWorse: 'worse quality',
    qualityChange: 'Changes quality by {delta} steps, resulting in {direction}.',
    profileHint: 'Uses the {profile} profile.',
    qvHint: 'Encoder parameter -q:v {value}.',
    compress: 'Compress',
    ...
    qualityBetter: 'better picture',
    qualitySame: 'no change',
    qualityWorse: 'more compressed',
    qualityChange: 'Adjusts encoder settings by {delta} steps → {direction}.',
    ...
    tagStrongCompatibility: 'High Compatibility',
